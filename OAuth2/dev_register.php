...
<div>
    <div class="container">
        ...
        <form action='dev_register_action.php'>
            <div class='content'>
        ...
        <div class="content" style="padding:2px 10px;display:inline-block;">Already have an account? <a href="http://localhost/identitymanagement/dev_login.php">Login.</a></div>
    </div>
</div>
</body>
</html>