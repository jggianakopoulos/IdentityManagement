	...
	<body class="background-color">
		<div>
			<div class="container">
				...
				<form action='dev_login_action.php'>
					<div class='content'>
				...
				<div class="content" style="padding:2px 10px;display:inline-block;">No account? <a href="http://localhost/identitymanagement/dev_register.php">Create one.</a></div>
			</div>
		</div>
	</body>
</html>