...
<div>
    <div class="container" style="display: block;padding: 0 100px;">
        ...
        <a style="padding: 2px 10px;display: inline-block;background-color: #d3d4ea;border: 1px #7d7d7d solid;border-radius: 6px;margin-top: 2px;"<a href="http://localhost/identitymanagement/dev_logout.php">Logout.</a>
    </div>
</div>
</body>
</html>