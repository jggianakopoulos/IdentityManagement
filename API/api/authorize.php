        ...
        <div class="container">
            <div class='content'>
                ...
                <div id="permission-section" class="hidden" >
                    <p style="margin:10px auto;max-width:300px;font-style:italic;text-align:center;">What information do you want to give to <b><?php echo $company; ?></b>?</p>
                    <div>
                    ...
                    <div style="margin:5px;">
                        <a href="<?php echo $cancel_url; ?>"><button class="btn nav-btn" style="float:left;" id='logout-btn' type="button">Return</button></a>
